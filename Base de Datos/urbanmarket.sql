...
-- Tiempo de generación: 29-08-2026 a las 04:02:42
...
INSERT INTO `productos` (`id_producto`, `nombre_producto`, `marca`, `precio`, `id_categoria`, `id_proveedor`) VALUES
(2, 'Azucar', 'azucar', 3000.00, 3, 1),
(3, 'Arroz', 'arroz', 2000.00, 3, 2),
(4, 'Leche', 'leche', 4000.00, 2, 3),
(5, 'Canela', 'canela', 1500.00, 4, 4),
(6, 'Bananos', 'banana', 4500.00, 1, 1);
